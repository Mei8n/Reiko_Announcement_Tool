...
public class menu_takeno_take extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_menu_takeno_take);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.menu_voice){
            ...
            p = MediaPlayer.create(getApplicationContext(), R.raw.an_102a0); //定義
            p.start(); //再生
        }

        else if(v.getId() == R.id.takeno_take_pl_button2){
            p = MediaPlayer.create(getApplicationContext(), R.raw.an_102a1); //定義
            p.start(); //再生
        }

        else if(v.getId() == R.id.takeno_take_pl_button3){
            p = MediaPlayer.create(getApplicationContext(), R.raw.an_102a2); //定義
            p.start(); //再生
        }
